...
//         // ✅ Lookup subCategory by name and get its ObjectId
//         const subCatDoc = await SubCategory.findOne({ name: subCategory });
//         if (!subCatDoc) {
//             return NextResponse.json({ message: `Invalid subCategory: ${subCategory}` }, { status: 400 });
//         }
...
//         const questionData = {
//             subCategory: subCatDoc._id, // ✅ use ObjectId
//             questionText,
//             questionType,
